              ...
              <div class="card-body px-5 py-5">
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control p_input">
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" name="password" class="form-control p_input">
                  </div>
