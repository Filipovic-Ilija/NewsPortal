          ...
          <div class="card-body py-0 px-0 px-sm-3">
            <div class="row align-items-center">
              ...
              <div class="col-5 col-sm-7 col-xl-8 p-0">
                <h4 class="mb-1 mb-sm-0">Welcome to News Portal by Filipovic</h4>
              </div>
              <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                <span>
                  <a href="{{ url('/') }}" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Visit News</a>
                </span>
              </div>
            </div>
          </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="title_en" class="form-control" id="exampleInputName1" value="{{ $post->title_en }}">
          </div>

          <div class="form-group col-md-6">
            <label for="exampleInputName1">Title Hindi</label>
            <input type="text" name="title_hin" class="form-control" id="exampleInputName1" value="{{ $post->title_hin }}">
          </div>
        ...
        <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" value="{{ $post->tags_en }}" name="tags_en" class="form-control" id="exampleInputName1">
            </div>
  
            <div class="form-group col-md-6">
              <label for="exampleInputName1">Tags Hindi</label>
              <input type="text" value="{{ $post->tags_hin }}" name="tags_hin" class="form-control" id="exampleInputName1">
            </div>
...
<div class="row">
    ...
    <label class="form-check-label col-md-3">
    <input type="checkbox" name="bigthumbnail" class="form-check-input" value="1" <?php if($post->bigthumbnail == 1) { echo "checked"; } ?>> General Bigthumbnail <i class="input-helper"></i></label>
