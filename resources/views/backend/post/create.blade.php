      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group">
            <label for="exampleFormControlFile1">New Image Upload</label>
...
<div class="row">
    ...
    <label class="form-check-label col-md-3">
    <input type="checkbox" name="bigthumbnail" class="form-check-input" value="1"> General Bigthumbnail <i class="input-helper"></i></label>
