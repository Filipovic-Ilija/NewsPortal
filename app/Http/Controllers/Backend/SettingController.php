...
class SettingController extends Controller
{
    public function SocialSetting(){
     ...
     public function SeoUpdate(Request $request,$id){
        ...
        $notification = array(
            ...
            'message' => 'Seos Setting Updated Successfully',
            'alert-type' => 'success'
        );
     ...
     public function ActiveSetting(Request $request, $id){
         ...
         $notification = array(
            ...
            'message' => 'Live Tv Active Updated Successfully',
            'alert-type' => 'success'
        );
     ...
     public function DeActiveSetting(Request $request, $id){
        ...
        $notification = array(
           ...
           'message' => 'Live Tv DeActive Updated Successfully',
           'alert-type' => 'success'
       );
   ...
   public function ActiveNoticeSetting(Request $request, $id){
      ...
      $notification = array(
         ...
         'message' => 'Notice Active Updated Successfully',
         'alert-type' => 'success'
     );
  ...
  public function DeActiveNoticeSetting(Request $request, $id){
     ...
     $notification = array(
        ...
        'message' => 'Notice DeActive Updated Successfully',
        'alert-type' => 'success'
    );
